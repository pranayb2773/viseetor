...
<div>
    <form wire:submit="register">
        ...
        <div>
            ...
            <x-input.text wire:model="first_name" id="first_name" class="mt-1 block w-full" type="text" name="first_name"
        ...
        <div>
            ...
            <x-input.text wire:model="last_name" id="last_name" class="mt-1 block w-full" type="text"
                name="last_name" required autofocus autocomplete="last_name" field="last_name" />
        ...
        <div class="mt-4">
            ...
            <x-input.text wire:model="email" id="email" class="mt-1 block w-full" type="email" name="email"
                required autocomplete="username" field="email" />
        ...
        <div class="mt-4">
            ...
            <x-input.text wire:model="password" id="password" class="mt-1 block w-full" type="password" name="password"
                required autocomplete="new-password" field="password" />
        ...
        <div class="mt-4">
            ...
            <x-input.text wire:model="password_confirmation" id="password_confirmation" class="mt-1 block w-full"
