<a class="text-xl font-bold leading-9 tracking-tight text-primary-500" href="/" wire:navigate>
    <span class="inline-flex items-center gap-2">
      <svg class="w-5 h-5 mx-auto" viewBox="0 0 232 232" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path
